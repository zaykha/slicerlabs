 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(D,W){var G=D.length;D.push(W);e:for(;0<G;){var ne=G-1>>>1,O=D[ne];if(0<i(O,W))D[ne]=W,D[G]=O,G=ne;else break e}}function n(D){return D.length===0?null:D[0]}function r(D){if(D.length===0)return null;var W=D[0],G=D.pop();if(G!==W){D[0]=G;e:for(var ne=0,O=D.length,I=O>>>1;ne<I;){var F=2*(ne+1)-1,Q=D[F],C=F+1,ee=D[C];if(0>i(Q,G))C<O&&0>i(ee,Q)?(D[ne]=ee,D[C]=G,ne=C):(D[ne]=Q,D[F]=G,ne=F);else if(C<O&&0>i(ee,G))D[ne]=ee,D[C]=G,ne=C;else break e}}return W}function i(D,W){var G=D.sortIndex-W.sortIndex;return G!==0?G:D.id-W.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var l=Date,a=l.now();e.unstable_now=function(){return l.now()-a}}var s=[],c=[],h=1,y=null,g=3,p=!1,w=!1,S=!1,L=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,d=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function m(D){for(var W=n(c);W!==null;){if(W.callback===null)r(c);else if(W.startTime<=D)r(c),W.sortIndex=W.expirationTime,t(s,W);else break;W=n(c)}}function k(D){if(S=!1,m(D),!w)if(n(s)!==null)w=!0,Lt(P);else{var W=n(c);W!==null&&ae(k,W.startTime-D)}}function P(D,W){w=!1,S&&(S=!1,f(z),z=-1),p=!0;var G=g;try{for(m(W),y=n(s);y!==null&&(!(y.expirationTime>W)||D&&!he());){var ne=y.callback;if(typeof ne=="function"){y.callback=null,g=y.priorityLevel;var O=ne(y.expirationTime<=W);W=e.unstable_now(),typeof O=="function"?y.callback=O:y===n(s)&&r(s),m(W)}else r(s);y=n(s)}if(y!==null)var I=!0;else{var F=n(c);F!==null&&ae(k,F.startTime-W),I=!1}return I}finally{y=null,g=G,p=!1}}var b=!1,_=null,z=-1,Z=5,H=-1;function he(){return!(e.unstable_now()-H<Z)}function pe(){if(_!==null){var D=e.unstable_now();H=D;var W=!0;try{W=_(!0,D)}finally{W?Le():(b=!1,_=null)}}else b=!1}var Le;if(typeof d=="function")Le=function(){d(pe)};else if(typeof MessageChannel<"u"){var Je=new MessageChannel,_e=Je.port2;Je.port1.onmessage=pe,Le=function(){_e.postMessage(null)}}else Le=function(){L(pe,0)};function Lt(D){_=D,b||(b=!0,Le())}function ae(D,W){z=L(function(){D(e.unstable_now())},W)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(D){D.callback=null},e.unstable_continueExecution=function(){w||p||(w=!0,Lt(P))},e.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Z=0<D?Math.floor(1e3/D):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(D){switch(g){case 1:case 2:case 3:var W=3;break;default:W=g}var G=g;g=W;try{return D()}finally{g=G}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(D,W){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var G=g;g=D;try{return W()}finally{g=G}},e.unstable_scheduleCallback=function(D,W,G){var ne=e.unstable_now();switch(typeof G=="object"&&G!==null?(G=G.delay,G=typeof G=="number"&&0<G?ne+G:ne):G=ne,D){case 1:var O=-1;break;case 2:O=250;break;case 5:O=1073741823;break;case 4:O=1e4;break;default:O=5e3}return O=G+O,D={id:h++,callback:W,priorityLevel:D,startTime:G,expirationTime:O,sortIndex:-1},G>ne?(D.sortIndex=G,t(c,D),n(s)===null&&D===n(c)&&(S?(f(z),z=-1):S=!0,ae(k,G-ne))):(D.sortIndex=O,t(s,D),w||p||(w=!0,Lt(P))),D},e.unstable_shouldYield=he,e.unstable_wrapCallback=function(D){var W=g;return function(){var G=g;g=W;try{return D.apply(this,arguments)}finally{g=G}}}})(Uf);(function(e){e.exports=Uf})(qm);/**
 * @license React
...
`,X1="/assets/shopping-cart1-762dd5a8.png",Z1=[{title:"Home",path:"/"},{title:"Services",path:"/services"},{title:"Materials",path:"/materials"},{title:"Learn",path:"/learn"},{title:"Contact",path:"/ContactUs"},{title:"Login",path:"/login"}],On=({togglesidebar:e})=>{const{pathname:t}=Gi(),{cartCount:n,setCartCount:r}=Cm();return M.useEffect(()=>{const i=JSON.parse(localStorage.getItem("cart")),o=i?i.length:0;r(o)},[r]),u(tt,{children:u(j1,{children:x(U1,{children:[u($1,{to:"/",children:u(G1,{src:pm,alt:"logo"})}),x(B1,{children:[u(H1,{onClick:e,children:u(F1,{})}),u(W1,{children:Z1.map(i=>u(V1,{children:u(sf,{to:i.path,isActive:t===i.path,children:i.title},i.title)}))})]}),x(Y1,{children:[u(uf,{children:u(K1,{to:"/Start3dPrinting",isActive:t==="/Start3dPrinting",children:t==="/Start3dPrinting"?"3D Printing":"Start 3D Printing"})}),u(uf,{children:x(sf,{to:"/cart",children:[u(Q1,{src:X1,alt:"cart"}),n>0&&u("span",{children:n})]})})]})]})})})},Ii=v.div`
    width:100%;
    text-align:center;
    color:white;
    font-size:1.6rem;
...
`,rw=v.div`
    ...
    display:flex;
    align-items:center;
`,iw=()=>{const[e,t]=M.useState(()=>{const r=localStorage.getItem("cart");return r?JSON.parse(r):[]});M.useEffect(()=>{localStorage.setItem("cart",JSON.stringify(e))},[e]);const n=r=>{const i=[...e];i.splice(r,1),t(i)};return x(tt,{children:[u(On,{}),x(Ii,{children:["CHECKOUT ",u(rt,{children:"PROCESS"})]}),u(Jl,{children:"Fast and Smooth Processing"}),e.length===0?u(rw,{children:u(Ii,{children:"No Items In Cart"})}):e.map((r,i)=>x(ew,{children:[x(tw,{children:["Print item ",i+1]}),x(So,{children:["Material:",r.material]}),x(So,{children:["Finishing: ",r.finishing]}),x(So,{children:["Dimension: ",r.dimension]}),x(So,{children:["Quantity: ",r.quantity]}),u(nw,{onClick:()=>n(i),children:"Remove"})]},i)),u(zn,{})]})},ow=v.div`
    width:1200px;
    margin:auto;
    display:flex;
    flex-wrap:wrap;
...
`,fw="/assets/location-680a28f3.png",pw="/assets/email-e6d61b71.png",hw="/assets/smartphone-91d55e36.png",mw=()=>x(tt,{children:[x(Ii,{children:["Contact ",u(rt,{children:"Us"})]}),u(Jl,{children:"We will get back to you within 1 business day."}),x(ow,{children:[x(lw,{children:[x(ja,{children:[u(Ua,{src:fw}),x(Ba,{children:[u($a,{children:"Address"}),u(Ha,{children:"3A Toh Guan Rd E, Singapore 608834"})]})]}),x(ja,{children:[u(Ua,{src:pw}),x(Ba,{children:[u($a,{children:"Contact"}),u(Ha,{children:"+65 6848 1548, +65 6784 1579"})]})]}),x(ja,{children:[u(Ua,{src:hw}),x(Ba,{children:[u($a,{children:"E-mail"}),u(Ha,{children:"contact@slicerlabs.com"})]})]}),x(gf,{children:[u(vf,{children:"Stay connected with Us"}),u(aw,{children:"Subscribe to our News letter to get updated on latest News and Promotions"}),u(yf,{children:"Subscribe"})]}),x(gf,{children:[u(vf,{children:"Already have a 3D file?"}),u(yf,{children:"Upload File"})]})]}),x(sw,{children:[x(uw,{children:[u(rt,{children:"Send"})," Message"]}),u(Wa,{name:"CTForm",type:"text",placeholder:"Full Name"}),u(Wa,{name:"CTForm",type:"email",placeholder:"Email"}),u(Wa,{name:"CTForm",type:"text",placeholder:"Message Topic"}),u(cw,{name:"CTForm",rows:"10",cols:"30",placeholder:"Your Message Here"}),u(dw,{children:"Send Message"})]})]})]}),gw=()=>x(tt,{children:[x(Ii,{children:["Get ",u(rt,{children:"Started"})]}),u(Jl,{children:"we are at the ready to assist you with your journey"}),u(J1,{children:x(q1,{children:[x(cf,{children:[x(df,{children:[u(rt,{children:"BLAZING FAST "}),"QUOTE"]}),u(ff,{children:"All online"}),x(pf,{children:["Already with 3D CAD files in STL, STEP or OBJ format? Upload your files for",u(hf,{children:"Instant Quote and Order Online!"})]}),u(mf,{children:"Start 3D Printing"})]}),x(cf,{children:[x(df,{children:[u(rt,{children:"READY"})," TO ANSWER"]}),u(ff,{children:"Always online"}),x(pf,{children:["Contact sales team. Let us know your requirements through",u(hf,{children:"contact form below."})]}),u(mf,{children:"Contact Us"})]})]})})]}),vw=()=>x(tt,{children:[u(On,{}),u(gw,{}),u(mw,{}),u(zn,{})]}),gt=v(qn)`
box-sizing: border-box;
    text-decoration: none;
    padding: 10px 21px;
    background: #F0F0F0;
...
`,xw=v.div`
    text-align: center;
    color: #FFFFFF;
`,Sw=()=>x(yw,{children:[u(ww,{children:"TRANSFORM YOU IDEAS INTO PHYSICAL OBJECTS"}),u(xw,{children:"with just a few clicks!"}),u(gt,{children:"Start 3D Printing"})]}),kw=v.div`
...
`,Zi=v.div`
    ...
    text-align: center;
    color: #48B2E5;
`,Lw="/assets/upload-6806a325.png",Rw=()=>x(Ur,{children:[u(Yi,{children:u(Xi,{src:Lw})}),x(ym,{children:[u(Zi,{children:"Instant quotes"}),u(qt,{children:"- No delays, No fuss"}),u(Ki,{children:"Frustrated with slow vendor replies? With us, getting a quote and placing an order for 3D printed parts takes just 5 seconds. You'll save an average of half the lead time compared to other vendors."}),u(gt,{children:"Get Your Quotes"})]})]}),Tw="/assets/Statsimg1-removebg-preview-57c39ccf.png",Mw="/assets/Statsimg2-removebg-preview-891e2017.png",Dw="/assets/Statsimg3-removebg-preview-a81b34f2.png",bw="/assets/Statsimg4-removebg-preview-0e5120ee.png",Nw=()=>u(Cw,{children:x(Ew,{children:[u(Pw,{children:"Experience the power of 3D printing"}),u(Aw,{children:"from design to delivery"}),x(vm,{children:[x(ko,{children:[u(Co,{children:"1-1000 parts"}),u(Eo,{src:Tw}),u(qt,{children:"Advance tech production"})]}),x(ko,{children:[u(Co,{children:"38% savings"}),u(Eo,{src:Mw}),u(qt,{children:"Competitive Pricing"})]}),x(ko,{children:[u(Co,{children:"3s Quote"}),u(Eo,{src:Dw}),u(qt,{children:"Instant Quotations"})]}),x(ko,{children:[u(Co,{children:"1-4 days"}),u(Eo,{src:bw}),u(qt,{children:"Lightning fast"})]})]})]})}),ql=v.div`
    width: 100%;
    // max-height: 500px;
...
`,zw=v.div`
    ...
    text-align: center;
    color: #fff;
`,Ow="/assets/Bro1-94c770a7.png",_w="/assets/woman-330ae479.png",Iw="/assets/Mark1-92e1215b.png",Fw=()=>u(ql,{children:x(Ur,{children:[u(zw,{children:"Enabling Designers and engineers everywhere to reach their full potential"}),x(vm,{children:[x(Va,{children:[u(Ga,{src:Ow}),u(Qa,{children:"Bec Brodie"}),u(Ka,{children:"Excellent quality and service. They were really knowledgeable about the different 3d printing techniques and were able to provide valuable suggestions to improve my work. Will definitely work with them again!"})]}),x(Va,{children:[u(Ga,{src:_w}),u(Qa,{children:"Ng Luo Wei"}),u(Ka,{children:"Affordable pricing with great printing quality. The service was also prompt and friendly. Highly recommend their 3D printing services!"})]}),x(Va,{children:[u(Ga,{src:Iw}),u(Qa,{children:"Bec Brodie"}),u(Ka,{children:"Really great team to deal with. I’ll be back soon!"})]})]})]})}),jw="/assets/1234-af5323d9.png",Uw=()=>x(Ur,{children:[u(Yi,{children:u(Xi,{src:jw})}),x(ym,{children:[u(Zi,{children:"High-Performance 3D Printing Materials"}),u(qt,{children:"- At Your FingerTips"}),u(Ki,{children:"From single parts to large runs, we have the functional materials you need. Our range of MJF, SLS, and FDM materials is perfect for high-stress applications. With build sizes up to 90cm, we can handle projects of any size."}),u(gt,{children:"Our Materials"})]})]}),wm="/assets/makerbot-bc6d7161.png",Bw=()=>u(ql,{children:x(Ur,{children:[x(mc,{children:[u(Zi,{children:"Complete 3D printing solutions "}),u(qt,{children:"– we've got you covered"}),u(Ki,{children:"From the convenience of your home, access our full range of plastic polymer 3D printing options, including SLA, SLS, FDM, and MJF. Experience top-quality prints at ultra-competitive rates and lightning-fast lead times."}),u(gt,{children:"View Our Techs"})]}),u(Yi,{children:u(Xi,{src:wm})})]})}),$w=()=>x(kw,{children:[u(On,{}),u(Sw,{}),u(Nw,{}),u(Rw,{}),u(Bw,{}),u(Uw,{}),u(Fw,{}),u(zn,{})]}),Hw=v.div`
    width:100%;
    padding: 40px;
    // border: 1px solid red;
...
`,Yw=()=>{const e=M.useRef(null),t=M.useRef(null);return M.useEffect(()=>{const n=()=>{const r=e.current.getBoundingClientRect().height;t.current.style.top=`${r+50}px`};return n(),window.addEventListener("resize",n),()=>{window.removeEventListener("resize",n)}},[]),x(Hw,{ref:e,children:[x(Ww,{children:[u(Vw,{children:"Learn more about 3D printing!"}),u(Gw,{children:"-SLA & FDM"}),u(Qw,{children:"Each technology has its own set of advantages and limitations, and the choice of technology will depend on the specific requirements of the project, such as resolution, strength, flexibility, and cost."}),u(gt,{children:"Know More"})]}),x(Kw,{ref:t,children:[u(Ya,{children:"OUR TECHNOLOGIES"}),u(Ya,{children:"OUR MATERIALS"}),u(Ya,{children:"OUR SERVICES"})]})]})},gc=v.div`
    Width: 100%;
    text-align: center;
    color: #999999;
`,wf=v.div`
...
`,fx="/assets/Blog-3-be709f55.jpg",px=()=>x(ea,{children:[x(Xw,{children:[x(Zw,{children:[u(Vo,{children:"Why 3D Print?"}),u(Go,{children:"3D printing has revolutionized the way we create and produce objects. With this technology, we can turn digital designs into physical objects with precision and accuracy. From prototyping to end-use parts, 3D printing offers endless possibilities for creating, testing and producing. With the advancement of materials and technologies, 3D printing is becoming more accessible and affordable for both individuals and businesses."})]}),u(Jw,{src:fx})]}),x(gt,{children:["Full Article ",">"]})]}),hx=()=>x(tt,{children:[u(On,{}),u(Yw,{}),u(px,{}),u(dx,{}),u(rx,{}),u(cx,{}),u(zn,{})]}),mx="/assets/login-ccbe8944.png",gx="/assets/lock-27635134.png",vx=v.div`
    font-size:1.8rem;
    width: 100%;
    text-align: center;
    color:white;
...
`,Lo=v.img`
    ...
    height: 30px;
    margin: 0 20px;
`,Lx="/assets/Googlelogo-93eb80dc.png",Rx="/assets/whatsapp-d15c880b.png",Tx="/assets/facebook-5065562b.png",Mx="/assets/linkedin-d087345c.png",Dx=()=>x(vc,{children:[x(yc,{children:[u(yx,{children:"Login"}),u(wx,{type:"text",placeholder:"User Name"}),u(xx,{type:"password",placeholder:"Password"}),x(uu,{children:[u(Sx,{type:"checkbox"}),u(kx,{children:"Remember me"}),u(Cx,{children:"Login"})]}),x(uu,{children:[u(Ex,{children:"Register Now"}),u(Px,{children:"Forget Password?"})]})]}),x(Ax,{children:[x(Ao,{children:[u(Lo,{src:Lx}),"Google"]}),x(Ao,{children:[u(Lo,{src:Rx}),"Whatsapp"]}),x(Ao,{children:[u(Lo,{src:Tx}),"Facebook"]}),x(Ao,{children:[u(Lo,{src:Mx}),"Linkedin"]})]})]}),bx=()=>x(tt,{children:[u(On,{}),u(vx,{children:"Welcome!"}),u(Dx,{}),u(zn,{})]}),Nx="/assets/Materialsimg-eb4f9912.png",zx=()=>u(ql,{children:x(Ur,{children:[x(mc,{children:[u(Zi,{children:"Complete 3D printing materials "}),u(qt,{children:"– SLA & FDM"}),u(Ki,{children:"Choose from our selection of premium 3D printing materials, including strong and durable functional nylon and flexible TPU rubber-like material. Our selection is constantly expanding."}),u(gt,{children:"Start 3D Printing"})]}),u(Yi,{children:u(Xi,{src:Nx})})]})}),Ox=v.div`
...
`,jx=()=>x(Ix,{children:[x(Fx,{children:[x(Rf,{children:[u(kl,{children:"Prototyping"}),u(Cl,{children:"SLA"}),u(Ar,{children:"Our  materials used in SLA technology are ABS-like, clear, gray and black resins, and castable resins. These materials are suitable for a wide range of applications such as prototyping, jewelry, dentistry, and many more."}),u(fn,{children:"Material 1"}),u(fn,{children:"Material 2"}),u(fn,{children:"Material 3"}),u(fn,{children:"Material 4"})]}),x(Rf,{children:[u(kl,{children:"Prototyping"}),u(Cl,{children:"SLA"}),u(Ar,{children:"Our  materials used in SLA technology are ABS-like, clear, gray and black resins, and castable resins. These materials are suitable for a wide range of applications such as prototyping, jewelry, dentistry, and many more."}),u(fn,{children:"Material 1"}),u(fn,{children:"Material 2"}),u(fn,{children:"Material 3"}),u(fn,{children:"Material 4"})]})]}),u(Ar,{children:"We provide fuss-free service using hobbyist FDM and SLA technologies with  competitive price"}),u(gt,{children:"Learn More"})]}),Ux="/assets/saer-c06a144d.jpg",Bx="/assets/asdw-92950fa1.jpg",$x=()=>x(tt,{children:[u(Af,{children:x(Ja,{children:[x(qa,{children:[u(Vo,{children:"General Purpose"}),u(es,{children:"Outstanding performance. Excellent detail."}),u(Go,{children:"Custom-formulated to deliver the highest-quality output, our Standard Resins capture astonishing detail without sacrificing strength."}),u(gt,{children:"Learn More"})]}),u(ts,{src:Ux})]})}),x(Ja,{children:[u(ts,{src:su}),x(qa,{children:[u(Vo,{children:"Engineering Resins"}),u(es,{children:"Functional prototyping materials."}),u(Go,{children:"Our library of versatile, reliable Engineering Resins is formulated to help you reduce costs, iterate faster, and bring better experiences to market."}),u(gt,{children:"Learn More"})]})]}),u(Af,{children:x(Ja,{children:[x(qa,{children:[u(Vo,{children:"Thermoplastic Filament"}),u(es,{children:"plant-based material "}),u(Go,{children:"PLA is a strong and durable material that is suitable for a wide range of applications, such as prototyping, low-volume production, and end-use parts."}),u(gt,{children:"Learn More"})]}),u(ts,{src:Bx})]})})]}),Hx=()=>x(tt,{children:[u(On,{}),x(gm,{children:["OUR ",u(rt,{children:" 3D PRINTING MATERIALS"})]}),u(zx,{}),u(jx,{}),u($x,{}),u(zn,{})]}),Wx="/assets/proto1-f8e81bda.png",Vx="/assets/proto2-9fea9804.png",Gx="/assets/proto3-4917f0cb.png",Qx="/assets/proto4-c6c13517.png",Kx="/assets/proto5-c8804d27.png",Yx=v.div`
  width: 1200px;
  height: 500px;
  position: relative;
  color:white;
...
`,ns=v.div`
    ...
    background: #292929;
    color: white;
`,fS=()=>u(uS,{children:x(cS,{children:[u(er,{children:"Products Applications"}),x(dS,{children:[u(ns,{children:"Prototyping"}),u(ns,{children:"End-use parts"}),u(ns,{children:"Custom designs"})]})]})}),pS=()=>u(ql,{children:x(Ur,{children:[x(mc,{children:[u(Zi,{children:"Complete 3D printing solutions "}),u(qt,{children:"– we've got you covered"}),u(Ki,{children:"From the convenience of your home, access our full range of plastic polymer 3D printing options, including SLA, SLS, FDM, and MJF. Experience top-quality prints at ultra-competitive rates and lightning-fast lead times."}),u(gt,{children:"Start 3D Printing"})]}),u(Yi,{children:u(Xi,{src:wm})})]})}),hS=()=>u(tt,{children:x(Ox,{children:[x(er,{children:["Product ",u(rt,{children:"Technologies"})]}),x(_x,{children:[x(Lf,{children:[u(kl,{children:"Prototyping"}),u(Cl,{children:"SLA"}),u(Ar,{children:"STEROLITHOGRAHY"})]}),x(Lf,{children:[u(kl,{children:"Functional"}),u(Cl,{children:"FDM"}),u(Ar,{children:"FUSED DEPOSITION MODELING"})]})]}),u(Ar,{children:"We provide fuss-free service using hobbisy FDM and SLA technologies with Competitive Price"}),u(gt,{children:"Learn More"})]})}),mS=v.div`
    margin: 40px auto;
`,gS=v.div`
    width: 1000px;
    margin: 20px auto;
...
`,Mo=v.div`
    width: 100%;
    text-align: center;
`,vS=()=>x(mS,{children:[x(er,{children:["Our ",u(rt,{children:" Materials "})," Includes"]}),x(gS,{children:[x(Ro,{children:[u(To,{children:"Plastic"}),u(Mo,{children:"Thermoplastic can be used to create a wide range of products. Some popular plastics used in 3D printing include ABS, PLA, PETG, Nylon and TPU."})]}),x(Ro,{children:[u(To,{children:"Ceramics"}),u(Mo,{children:"3D printing technology can also be used to print ceramic materials, such as porcelain and clay."})]}),x(Ro,{children:[u(To,{children:"Bio-materials"}),u(Mo,{children:"3D printing technology can be used to print with bio-materials, such as cells, hydrogels and other biological materials, which are used in the medical field for tissue engineering, drug development and regenerative medicine."})]}),x(Ro,{children:[u(To,{children:"Composites"}),u(Mo,{children:"3D printing technology can also be used to print parts using composites materials such as carbon fiber, glass fiber, and other materials which are reinforced with fibers."})]})]})]}),yS=()=>x(tt,{children:[u(On,{}),x(gm,{children:["OUR ",u(rt,{children:" SERVICES"})]}),u(pS,{}),u(hS,{}),u(fS,{}),u(vS,{}),u(sS,{}),u(zn,{})]}),Tf=v.div`
    box-sizing: border-box;
    text-decoration: none;
    padding: 5px 21px;
    background: #F0F0F0;
...
`,wS=v.div`
    ...
    color: #D3D3D3;
    font-size: 1.2rem;
`,xS=()=>u(vc,{children:x(yc,{children:[u(Tf,{children:"Single file upload"}),u(Tf,{children:"Multi-file upload"}),u(rs,{children:"Support files -(STL,OBJ)"}),u(rs,{children:"Max file size - 60MB"}),u(rs,{children:"Model measurment - mm"}),u(wS,{children:"Or Drop the File Directly."})]})}),Do=v.label`
    width: 100%;
    text-align:left;
    font-size: 0.8rem;
    color:#a4a4a4;
...
`,Df=v.button`
  ...
  border: none;
  cursor: pointer;
`,AS=()=>{const{cartCount:e,setCartCount:t}=Cm(),n=M.useRef(null),r=M.useRef(null),[i,o]=M.useState(""),[l,a]=M.useState(""),[s,c]=M.useState(""),[h,y]=M.useState(0),[g,p]=M.useState([]),w=qh();M.useEffect(()=>{const f=localStorage.getItem("cart");f&&p(JSON.parse(f))},[]),M.useEffect(()=>{console.log(JSON.parse(localStorage.getItem("cart")))},[g]);const S=()=>{const f={material:i,finishing:l,dimension:s,quantity:h};if(!i||!l||!s||!h)alert("please fill in empty fields");else{const d=[...g,f];p(d),localStorage.setItem("cart",JSON.stringify(d)),o(""),a(""),c(""),y(0),t(d.length)}},L=()=>{const f={material:i,finishing:l,dimension:s,quantity:h};if(g.length>0)if(!i&&!l&&!s&&!h){const d=encodeURIComponent(JSON.stringify(g));w(`/cart?cart=${d}`)}else if(!i||!l||!s||!h)alert("please fill all in empty fields or empty the field to proceed");else{const d=[...g,f];p(d),localStorage.setItem("cart",JSON.stringify(d)),o(""),a(""),c(""),y(0);const m=encodeURIComponent(JSON.stringify(g));w(`/cart?cart=${m}`)}else if(alert("please add to cart"),!i||!l||!s||!h)alert("please fill in empty fields");else{const d=[...g,f];p(d),localStorage.setItem("cart",JSON.stringify(d)),o(""),a(""),c(""),y(0);const m=encodeURIComponent(JSON.stringify(g));w(`/cart?cart=${m}`)}};return M.useEffect(()=>{const f=()=>{const d=n.current.getBoundingClientRect().height;r.current.style.top=`${d+520}px`};return f(),window.addEventListener("resize",f),()=>{window.removeEventListener("resize",f)}},[]),x(tt,{children:[u(vc,{ref:n,children:x(yc,{children:[u(Do,{htmlFor:"material",children:"Materials"}),x(is,{value:i,onChange:f=>o(f.target.value),children:[u(Ie,{value:"",children:"Please Select a Material"}),u(Ie,{value:"ABS",children:"Acrylonitrile Butadiene Styrene (ABS)"}),u(Ie,{value:"PLA",children:"Polylactic Acid (PLA)"}),u(Ie,{value:"TPU",children:"Thermoplastic Polyurethane (TPU)"}),u(Ie,{value:"Nylon",children:"Nylon"}),u(Ie,{value:"PETG",children:"Polyethylene Terephthalate Glycol (PETG)"}),u(Ie,{value:"Resin",children:"Resins"})]}),u(Do,{htmlFor:"finishing",children:"Finshing & Color"}),x(is,{value:l,onChange:f=>a(f.target.value),children:[u(Ie,{value:"",children:"Please Select a Color"}),u(Ie,{value:"white",children:"White"}),u(Ie,{value:"black",children:"Black"}),u(Ie,{value:"transparent",children:"Transparent"})]}),u(Do,{htmlFor:"dimension",children:"Dimension ( Length x Width x Height )"}),x(is,{value:s,onChange:f=>c(f.target.value),children:[u(Ie,{value:"",children:"Please Select a Dimension"}),u(Ie,{value:"10",children:"10 x 10 x 10"}),u(Ie,{value:"20",children:"20 x 20 x 20"}),u(Ie,{value:"30",children:"30 x 30 x 30"}),u(Ie,{value:"40",children:"40 x 40 x 40"}),u(Ie,{value:"50",children:"50 x 50 x 50"}),u(Ie,{value:"custom",children:"custom"})]}),u(Do,{htmlFor:"quantity",children:"Quantity"}),x(uu,{children:[u(SS,{type:"number",placeholder:"Quantity",min:"0",value:h,onChange:f=>y(f.target.value)}),u(qr,{children:"x "}),u(qr,{children:"$ 0 "}),u(qr,{children:"= "}),u(qr,{children:"$ 0"})]}),u(qr,{children:"Your Product will be Produced in ? business days."})]})}),x(kS,{ref:r,children:[u(Mf,{onClick:S,children:"ADD TO CART"}),g.length>0?u(tt,{children:x(Mf,{onClick:L,children:["CHECK OUT",g&&u(CS,{children:g.length})]})}):u(tt,{})]})]})},LS=()=>{const[e,t]=M.useState(!1),n=o=>{e&&(o.preventDefault(),o.returnValue="Are you sure you want to leave? Your cart will be emptied.")},r=()=>{t(!1)},i=()=>{localStorage.removeItem("cart"),window.location.reload()};return M.useEffect(()=>(window.addEventListener("beforeunload",n),()=>{window.removeEventListener("beforeunload",n)}),[e]),x(tt,{children:[e&&u(ES,{children:x(PS,{children:[u("h3",{children:"Warning"}),u("p",{children:"Leaving this page will remove all items from your cart."}),x("div",{children:[u(Df,{onClick:r,cancel:!0,children:"Cancel"}),u(Df,{onClick:i,ok:!0,children:"OK"})]})]})}),u(On,{}),x(Ii,{children:["UPLOAD ",u(rt,{children:"FILE"})]}),u(Jl,{children:"to get instant quote!"}),u(xS,{}),u(AS,{}),u(zn,{})]})},km=st.createContext({cartCount:0,setCartCount:()=>{}});function Cm(){return M.useContext(km)}function RS(){const e=JSON.parse(localStorage.getItem("cart"))||[],t=e.length||0,[n,r]=M.useState(e),[i,o]=M.useState(t),l=p=>{if(p.key==="cart"){const w=JSON.parse(p.newValue);r(w||[]),o(w?w.length:0)}};M.useEffect(()=>{const p=JSON.parse(localStorage.getItem("cart"));return p&&(r(p),o(p.length)),window.addEventListener("storage",l),()=>{window.removeEventListener("storage",l)}},[]),M.useEffect(()=>{o(n.length),localStorage.setItem("cart",JSON.stringify(n)),console.log(localStorage.getItem("cart"))},[n]);const[a,s]=M.useState(!1),c=p=>{a&&(p.preventDefault(),p.returnValue="Are you sure you want to leave? Your cart will be emptied.")},h=()=>{s(!1)},y=()=>{localStorage.removeItem("cart"),window.location.reload()};M.useEffect(()=>(window.addEventListener("beforeunload",c),()=>{window.removeEventListener("beforeunload",c)}),[a]);const g=wy([{path:"/",element:u($w,{})},{path:"/services",element:u(yS,{})},{path:"/Materials",element:u(Hx,{})},{path:"/Learn",element:u(hx,{})},{path:"/ContactUs",element:u(vw,{})},{path:"/Login",element:u(bx,{})},{path:"/Start3dPrinting",element:u(LS,{})},{path:"/cart",element:u(iw,{showPrompt:a,handleOk:y,handleHidePrompt:h})}]);return u(km.Provider,{value:{cartCount:i,setCartCount:o},children:u(dy,{router:g})})}ls.createRoot(document.getElementById("root")).render(u(st.StrictMode,{children:u(RS,{})}));
